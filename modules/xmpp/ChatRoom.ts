...
export default class ChatRoom extends Listenable {
    ...
    private cmeetMeetingId?: string;
    private rocketChatRoomId?: string;
    private roomOwner?: string;
    private displayName?: string;
    private tokenCmeet?: string;
    private rocketChatUserId?: string;
    private rocketChatAuthToken: string;
    private rocketChatType?: string;
    public xmpp: XMPP;
